...
if (isset($_POST['btn'])) {
    ...
    $kq = updateProduct($tenSP, $donGia, $giamGia, $hinhAnh, 0, $thongSo, $moTa, $anHien, $idLoai, $idSP);
    if ($kq != true) {
        echo "<script>
    ...
    <div class="card-body">
        ...
        <form class="forms-sample" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputUsername1" placeholder="link ảnh" name="hinhAnh" value="<?= $sanPham['hinhAnh'] ?>">
            </div>
            <div class="form-group">
